...
EmployeeView = (function() {
  ...
  function EmployeeView(details) {
    ...
    this.el = $('<div class="page"/>').on('click', '.add-contact-btn', this.addToContacts).on('click', '.add-location-btn', this.addLocation).on('click', '.change-pic-btn', this.changePicture);
  }
